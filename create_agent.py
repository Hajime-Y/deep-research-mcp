...
def create_agent(model_id="o1"):
    ...
    manager_agent.prompt_templates["managed_agent"]["task"] += """Also, please make sure to verify that the output content and format requested in the task are correct before returning your final_answer."""
    # 日本語訳:
